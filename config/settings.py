...
DATABASES = {
    "default": {
        ...
        "NAME": env("MYSQL_DATABASE", default="townetrl_townflow2"),
        "USER": env("MYSQL_USER", default="townetrl_townflow2user"),
...
SIMPLE_JWT = {
    "ACCESS_TOKEN_LIFETIME": timedelta(minutes=env.int("JWT_ACCESS_TOKEN_LIFETIME_MINUTES", default=20)),
...
CACHE_BACKEND = env("CACHE_BACKEND", default="db").strip().lower()
if CACHE_BACKEND == "redis":
...
elif CACHE_BACKEND in {"db", "database"}:
    ...
    raise ValueError("Invalid CACHE_BACKEND. Use one of: redis, db, database")
